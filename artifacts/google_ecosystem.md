...
**The "Second Brain" for Students.**
Most people use ChatGPT, but NotebookLM is different. You upload your PDFs/Notes, and it becomes an expert *only* on that specific data.
...
### 2. [Google Whisk (Saved)](https://www.google.com/save)
**The Recipe & Food AI.**
*Note: This project evolves often.* It allows you to save recipes from anywhere on the web and instantly turns them into a shopping list.
* **Why it matters:** It shows how Google creates "Collections" across the web.

### 3. [Project Gameface](https://github.com/google/project-gameface)
**Control PC with your Face.**
An open-source hands-free gaming mouse. It uses the webcam to track facial expressions and moves the cursor.
...
### 4. [Google FX / ImageFX](https://aitestkitchen.withgoogle.com/)
**The Midjourney Killer?**
Part of Google's "AI Test Kitchen." It generates high-quality images with text, but the interface is built for *creators*, not just prompters.
* **Feature:** "Expressive Chips" let you quickly swap styles without rewriting the prompt.

### 5. [MusicFX](https://aitestkitchen.withgoogle.com/tools/music-fx)
**Text-to-Music.**
You type "Lo-fi beat for coding in a rainstorm," and it generates a seamless loop.
* **Status:** Experimental.
...
### 7. [Google Font & Icon Library](https://fonts.google.com/icons)
